...
public class Keygenerator{
	...
	public static void main(String[] args){
		...
		File pbk = new File("./client-public.key");
		...
		pbk = new File("./client-private.key");
		fos = new FileWriter(pbk);
		byte[] privateKeyBytes = privateKeyClient.getEncoded();
		String privKeyStr = new BASE64Encoder().encode(privateKeyBytes);
		fos.write(privKeyStr);
		fos.flush();
		fos.close();
